...
namespace GameLibrary.Services.Implementations
{
    public class CampanaService : ICampanaService
    {
        ...
        public IEnumerable<CampanaResponseDto> GetActivas()
        {
            ...
            return _campanaRepo.GetActivas(ahora).Select(c => ToDto(c, ahora));
        }
        ...
        public CampanaResponseDto Create(CampanaCreateDto dto)
        {
            ...
            if (dto.CategoriaId.HasValue && _categoriaRepo.GetById(dto.CategoriaId.Value) is null)
                throw new NotFoundException($"No existe la categoría con Id {dto.CategoriaId}.");

            if (dto.DesarrolladoraId.HasValue && _desarrolladoraRepo.GetById(dto.DesarrolladoraId.Value) is null)
        ...
        public Campana? ObtenerMejorPromocion(Juego juego, DateTime fecha)
        {
            ...
            return _campanaRepo.GetActivas(fecha)
